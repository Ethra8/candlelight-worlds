...
#### MOBILE
  ...
  ![image](https://github.com/user-attachments/assets/1db7bbfd-1869-434f-b229-b1cc6aed1f47)  

  [LightHouse Report.pdf](https://github.com/user-attachments/files/17236131/LightHouse.Report.pdf)
...
This website has been scanned for accessibility issues, and 5 total errors have arised. Unfotunately With free subscription of [EqualWeb Accessibility Checker](https://www.equalweb.com/) I can't get more detail for now, but after the [LightHouse Report](#lighthouse-reports), it can't be important errors, and will be fixed in a near future to be fully compliant with the highest international accessibility standards:  
  
  ![image](https://github.com/user-attachments/assets/f80b1e66-27e1-49b4-8108-a1d348e2dd04)
